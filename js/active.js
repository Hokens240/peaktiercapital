...
// 2.6 WOW - On Scroll Animation [This code depends on {WOW} plugin.]
...
const saasboxSelectItem = document.querySelectorAll('.saasbox-select');

if (saasboxSelectItem.length > 0) {
    saasboxSelectItem.forEach((element) => {
